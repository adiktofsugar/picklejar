/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./wrangler-types.d.ts` (hash: 9d977543f1211f7efb1c0c5504d53897)
// Runtime types generated with workerd@1.20251217.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
	}
	interface Env {
		ENCRYPTION_KEY: "dev-only-replace-in-production";
		db: D1Database;
		SyncSourceWorkflow: Workflow<Parameters<import("./worker/index").SyncSourceWorkflow['run']>[0]['payload']>;
		ProcessPhotosWorkflow: Workflow<Parameters<import("./worker/index").ProcessPhotosWorkflow['run']>[0]['payload']>;
	}
}
